...
summary: "Energy price shocks pass through to headline and core inflation much more strongly in states of high _supply chain uncertainty_. We document this for the US and the euro area. We build an NK model with firms' supply chains and Bayesian signal extraction under imperfect information to rationalize the evidence."
---
...
**Status.** Working paper (updated: April 2026).
